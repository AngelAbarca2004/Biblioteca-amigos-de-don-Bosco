...
CREATE TABLE `cds` (
  ...
  CONSTRAINT `cds_ibfk_1` FOREIGN KEY (`id_ejemplar`) REFERENCES `ejemplares` (`id`),
  CONSTRAINT `cds_ibfk_2` FOREIGN KEY (`id_genero`) REFERENCES `generos` (`id`),
  CONSTRAINT `cds_ibfk_3` FOREIGN KEY (`id_artista`) REFERENCES `artistas` (`id`)
