...
CREATE TABLE `tesis` (
  ...
  CONSTRAINT `tesis_ibfk_1` FOREIGN KEY (`id_ejemplar`) REFERENCES `ejemplares` (`id`),
  CONSTRAINT `tesis_ibfk_2` FOREIGN KEY (`id_universidad`) REFERENCES `universidades` (`id`)
